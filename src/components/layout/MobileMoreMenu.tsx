...
export function MobileMoreMenu({ isOpen, onClose, profile }: MobileMoreMenuProps) {
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-y-0 right-0 z-[101] w-[280px] bg-background border-l border-border flex flex-col shadow-2xl md:hidden"
                    >
                        {/* Header */}
                        ...
                        <div className="px-6 py-6 border-b border-border">
                            <div className="flex items-center gap-4 bg-card/50 p-4 rounded-2xl border border-border/50">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="font-bold text-foreground truncate">{profile?.full_name || 'Coach'}</p>
                                    <p className="text-[10px] text-muted-foreground uppercase tracking-widest mt-0.5">Coach Professionista</p>
                                </div>
                            </div>
                        </div>
